...
const analysisOfRequirements = "The process of determining user expectations for a new or modified."
const design = "Desiging the code, taking into account the original view and scope of the project."
